...
try {
  ...
  $cn = new Conexion();
  $con = $cn->Conectar();
  $stmt = $con->prepare("SELECT dbo.MovilAlertas.id_alerta, dbo.MovilCiudadano.id, dbo.MovilAlertas.titulo, dbo.MovilAlertas.descripcion, dbo.MovilAlertas.fecha, dbo.MovilAlertas.ubicacion, dbo.MovilAlertas.alertaimg, dbo.MovilAlertas.longitud, dbo.MovilAlertas.latitud, dbo.MovilCiudadano.Nombre, dbo.MovilCiudadano.ApellidoP, dbo.MovilCiudadano.ImgURL
