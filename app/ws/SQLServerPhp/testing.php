<?php 
 ...
 <body>
  <div class=""><div class="aHl"></div><div id=":li" tabindex="-1"></div><div id=":jm" class="ii gt"><div id=":jn" class="a3s aXjCH m163a1be058bfda1b"><u></u>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border:none;border-collapse:collapse" width="600" class="m_2647829932658133818devicewidth">
                    <tbody><tr>
                      <td align="center" style="padding:25px 5px 25px 5px;font-family:arial,sans-serif;font-size:12px;font-weight:400" class="m_2647829932658133818block">
                        <div style="color:#484848;font-family:helvetica,arial,sans-serif;font-size:17px;font-weight:400;padding-bottom:11px" class="m_2647829932658133818pb0">Evernote syncs across all your devices.</div>
