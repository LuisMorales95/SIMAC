...
//Oficio
  ...
  if ($body['OficioR']<>'') {
	...
	try {
	  ...
	  $stmt = $con->prepare("INSERT INTO Oficio VALUES ( :cla_Oficio , :nom_Oficio , :asu_oficio , :ubi_oficio , :notas , :fkid_departamento , :fkid_estado , :fkid_persona, :DepEnvi_Oficio, :RutaOficioP, :RutaOficioR);");
	  $stmt->execute(array(
