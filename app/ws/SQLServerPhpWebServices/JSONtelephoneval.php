...
include 'conn.php';
  ...
  try {
    ...
    $cn = new Conexion();
    $con = $cn->Conectar();
    $stmt = $con->prepare('SELECT dbo.MovilCiudadano.Id, dbo.MovilCiudadano.Contrasena, dbo.MovilCiudadano.Token, dbo.MovilCiudadano.ImgUrl, dbo.MovilCiudadano.Nombre, dbo.MovilCiudadano.CorreoE, dbo.MovilCiudadano.fk_id_rol, dbo.MovilCiudadano.Verificacion_Usuario FROM dbo.MovilCiudadano WHERE Telefono = :telefono;');
