...
$cr = "C:/inetpub/wwwroot/Portalsirem/mtztorre/103/croquis/".$body['ImageCroq'];
...
$ft = "C:/inetpub/wwwroot/Portalsirem/mtztorre/103/fotos/".$body['ImageFoto'];
...
try {
      ...
      ,OTROUSO
      ,NOTIFICACION
      ,OBSERVACION) VALUES ((SELECT TOP 1 (IDLEVANTAMIENTOCAMPO+1) AS C FROM catastro.LEVANTAMIENTOCAMPO ORDER BY IDLEVANTAMIENTOCAMPO DESC),:idtc, :cr, :ft, :lt, :lng, :alt, :idup, :otro, :notif, :obs)");
