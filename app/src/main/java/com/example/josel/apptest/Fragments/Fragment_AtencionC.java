...
public class Fragment_AtencionC extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        preferences = getActivity().getSharedPreferences("Credenciales",MODE_PRIVATE);
        ...
        new jalar_noticias(view.getRootView(),String.valueOf(number),UserData.SERVER_ADDRESS+"JSONSelectNoticiasCiudadanos.php",NoticiaCiudadana_lista).execute();
        ...
        if (preferences.getString("ID","").isEmpty()){
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.flContent,fragmentLogin).addToBackStack(null).commit();
                }
            });
        }else{
...
//                startActivity(new Intent(getView().getContext(),Activity_NoticiaIndividual.class));
////                Snackbar.make(getView(),"position: "+position,Snackbar.LENGTH_LONG).show();
//            }
//        });
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1, final int pos, long id) {
                ...
                Button cancel = (Button) sweetAlertDialog.findViewById(cn.pedant.SweetAlert.R.id.cancel_button);
                if (cancel != null) {
                ...
                Button accept = (Button) sweetAlertDialog.findViewById(cn.pedant.SweetAlert.R.id.confirm_button);
                if (accept != null) {
                    Log.e("Messeage from pdialog", "showErrorMsg: Button view Found yep");
...
//                Toast.makeText(getContext(), "long clicked, "+"pos: " + pos, Toast.LENGTH_LONG).show();
    ...
    public class borrarNoticia extends AsyncTask<Void,Boolean,Boolean> {
        ...
        protected void onPostExecute(Boolean aBoolean) {
            if (aBoolean){
                ...
                Button cerrar = (Button) successDialog.findViewById(cn.pedant.SweetAlert.R.id.confirm_button);
                if (cerrar!=null){
                    Log.e("Messeage from pdialog", "showErrorMsg: Button view Found yep");
    ...
    public static class jalar_noticias extends AsyncTask<Void,Boolean,Boolean> {
        ...
        public jalar_noticias(View rootview, String numero, String url, List<NoticiaCiudadana> noticiaCiudadana) {
        ...
        protected Boolean doInBackground(Void... voids) {
            if (!preferences.getString("ID","").isEmpty()){
                ...
                datatosend.add(new BasicNameValuePair("id_usuario",preferences.getString("ID","")));
                HttpParams httpRequestParams = HTTPPARAMS.GETHTTPREQUESTPARAMS();
                HttpClient client = new DefaultHttpClient(httpRequestParams);
                HttpPost post = new HttpPost(UserData.SERVER_ADDRESS+"JSONSelectNoticiasCiudadanoscopia.php");
                // ++ RESPONSE FROM SERVER ++
                HttpResponse httpResponse = null;
                String responsedecoded = "";
                ...
                HttpParams httpRequestParams = HTTPPARAMS.GETHTTPREQUESTPARAMS();
                HttpClient client = new DefaultHttpClient(httpRequestParams);
                HttpPost post = new HttpPost(UserData.SERVER_ADDRESS+"JSONSelectNoticiasCiudadanos.php");
                // ++ RESPONSE FROM SERVER ++
                HttpResponse httpResponse = null;
                String responsedecoded = "";
    ...
    private ArrayList<NoticiaCiudadana> getMoreData() {
        ...
        new jalar_noticias(getActivity().getCurrentFocus(),String.valueOf(number),UserData.SERVER_ADDRESS+"JSONSelectNoticiasCiudadanos.php",lst).execute();
    ...
    public class CustomListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, final ViewGroup parent) {
            ...
            NetworkImageView  noticiaimg = (NetworkImageView) convertView.findViewById(R.id.noticiaimg);
            ...
            MeGusta.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (preferences.getString("ID","").isEmpty()){
                        Toast.makeText(getActivity(),"Necesita Iniciar sesión",Toast.LENGTH_SHORT).show();
                    }else{
                        if (m.getLike().equals("1")){
//                          TODO: AQUI SE BORRA
                            new Like_Management(
                                    Fragment_AtencionC.this.getView(),
                                    Integer.valueOf(preferences.getString("ID","")),
                                    Integer.valueOf( m.getId()),
                                    Integer.valueOf( m.getLike()),
                                    m,
                                    adapter).execute();
                            /*m.setLike("0");*/
                        }else{
//                          TODO: AQUI SE CREEA
            ...
            clickAlert.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    posilista=position;
                    Activity_NoticiaIndividual.opcion=1;
                    startActivity(new Intent(Fragment_AtencionC.this.getView().getContext(),Activity_NoticiaIndividual.class));
//                    Snackbar.make(Fragment_AtencionC.this.getView(),"position: "+position,Snackbar.LENGTH_LONG).show();
                }
            });
            if (m.getId_usuario().equals(preferences.getString("ID",""))){
...
//                Toast.makeText(getContext(), "long clicked, "+"pos: " + pos, Toast.LENGTH_LONG).show();
    ...
    public static class Like_Management extends AsyncTask<Void,Integer,Integer>{
        ...
        public Like_Management(View v, int iduser, int idnews, int opcion, NoticiaCiudadana noticia, CustomListAdapter adapter) {
            this.v = v;
            this.iduser = iduser;
            this.idnews = idnews;
            this.opcion = opcion;
        ...
        protected Integer doInBackground(Void... voids) {
            ...
            datatosend.add(new BasicNameValuePair("opcion",String.valueOf(opcion))); //TODO: "0" es para crear "1" borrar
            HttpParams httpRequestParams = HTTPPARAMS.GETHTTPREQUESTPARAMS();
            HttpClient client = new DefaultHttpClient(httpRequestParams);
        ...
        protected void onPostExecute(Integer aInteger) {
            switch (aInteger){
                case 0:
                    Toast.makeText(v.getContext(),"ERROR: 101 Actualize la ventana",Toast.LENGTH_SHORT).show();
                    break;
                case 1:
                    Toast.makeText(v.getContext(),"Operación Fallida OF001",Toast.LENGTH_SHORT).show();
                    break;
                case 2:
                    noticia.setLike("1");
                    adapter.notifyDataSetChanged();
                    break;
                case 3:
                    Toast.makeText(v.getContext(),"Operación Fallida OF002",Toast.LENGTH_SHORT).show();
                    break;
                case 4:
                    noticia.setLike("0");
                    adapter.notifyDataSetChanged();
                    break;
                case 5:
                    Toast.makeText(v.getContext(),"Operación Fallida OF003",Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    }
