        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                new AlertDialog.Builder(Activity_Get_ValidationCode.this)
                        .setMessage("La verificación no se ha podido realizar en este momento")
                                            ...
                                            public void onResponse(String response) {
                                                try {
                                                    ...
                                                    if (exito.equals("SI")) {
                                                        ...
                                                        final android.app.AlertDialog.Builder
                                                                builder = new android.app.AlertDialog.Builder(Activity_Get_ValidationCode.this);
