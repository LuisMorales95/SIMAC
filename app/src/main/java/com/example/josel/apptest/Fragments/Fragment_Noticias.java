        ...
        */
        ...
        listnoticias.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Activity_NoticiaMunicipal.position=position;
                Activity_NoticiaMunicipal.NoticiaMunicipal=NoticiaCiudadana_lista;
...
/*
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            try {
                ...
                for (int i = 0; i<jsonArray.length();i++){
                    ...
                    NoticiaCiudadana.setDescripcion(jsonArray.getJSONObject(i).getString("descipcion"));
                    ...
                    NoticiaCiudadana.setNoticiaimagen(jsonArray.getJSONObject(i).getString("noticiaimg"));
    ...
    public class CustomListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            municipio_imagen.setImageUrl(m.getNoticiaimagen(),imageLoader);
