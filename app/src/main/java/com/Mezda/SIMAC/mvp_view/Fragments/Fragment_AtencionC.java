...
import com.Mezda.SIMAC.mvp_view.Activitys.Activity_Comments;
import com.Mezda.SIMAC.mvp_view.Activitys.Activity_Main;
import com.Mezda.SIMAC.mvp_view.Activitys.Activity_NoticiaIndividual;
...
public class Fragment_AtencionC extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ((Activity_Main) getActivity()).setActionBarTitle("Alertas");
        ((Activity_Main) getActivity()).selectItem(R.id.Alertas);
...
*/
    ...
    public class CustomListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, final ViewGroup parent) {
            ...
            Glide.with(convertView.getContext()).load(UserData.SERVER_ADDRESS + m.getNoticiaimagen()).into(noticiaimg);
            Glide.with(convertView.getContext()).load(UserData.SERVER_ADDRESS + m.getUserimagen()).into(Imageuser);
